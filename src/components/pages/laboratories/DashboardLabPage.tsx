...
//       return [];
//     }
//     const allClients = orders.map((order) => order.users_permissions_user);
...
//     const numberOfCustomers = clients.length;
...
//         const { title, pricing, stock } = item.product; // Retrieve title, pricing, and stock from product
...
//       { title: "N/A", quantity: 0, price: 0, stock: null }
//     );

//     const leastSoldProduct = salesPerProduct.reduce(
//       (min: any, product: any) =>
//         product.quantity < min.quantity ? product : min,
//       { title: "N/A", quantity: Infinity, price: 0, stock: null }
//     );
...
//           const customer = clients.find((c) => c.id.toString() === customerId);
//           return {
...
//   return (
//     <main className="p-6 space-y-6 w-full max-w-[1000px] mx-auto">
